...
##  Cyber Operations Repository - Network/ Host Analysis Toolkit  ## 
##                Copyright (C) 2020 Danika Nilson                ##
####################################################################
...
function Discover-Hosts
{
    ...
    echo "Date/ Time: $(Get-Date)" >> ##<enter Accountability.csv pathway here>
    echo "Operator initials: $($global:initials)" >> ##<enter Accountability.csv pathway here>
    echo "Command used: " >> ##<enter Accountability.csv pathway here>
    echo "Discover-Hosts -Subnet $($Subnet) -Exclude $($Exclude)" >> ##<enter Accountability.csv pathway here>
    echo "" >> ##<enter Accountability.csv pathway here>
    }
}
...
function PII-Location
{
    ...
    Process
    {
        ...
        Select-String -Path $Search -Pattern $RegularExpression -AllMatches | Select-Object Path, LineNumber -ExpandProperty Matches
        echo "Date/ Time: $(Get-Date)" >> ##<enter Accountability.csv pathway here>
        echo "Operator initials: $($global:initials)" >> ##<enter Accountability.csv pathway here>
        echo "Command used: " >> ##<enter Accountability.csv pathway here>
        echo "Select-String -Path $($Search) -Pattern $($RegularExpression) -AllMatches | Select-Object Path, LineNumber -ExpandProperty Matches" >> ##<enter Accountability.csv pathway here>
        echo "" >> ##<enter Accountability.csv pathway here>
    ...
    (
       ...
       Process
        ...
        if($Hidden) 
            ...
            echo "Operator initials: $($global:initials)" >> ##<enter Accountability.csv pathway here>
            echo "Command used: " >> ##<enter Accountability.csv pathway here>
            echo "Get-ChildItem -Attributes !Directory -Path $($FilePath) -Force -Recurse -Include $($Extension)" >> ##<enter Accountability.csv pathway here>
            echo "" >> ##<enter Accountability.csv pathway here>
            }
        else {
            ...
            echo "Operator initials: $($global:initials)" >> ##<enter Accountability.csv pathway here>
            echo "Command used: " >> ##<enter Accountability.csv pathway here>
            echo "Get-ChildItem -Attributes !Directory -Path $($FilePath) -Recurse -Include $($Extension)" >> ##<enter Accountability.csv pathway here>
            echo "" >> ##<enter Accountability.csv pathway here>
             }
        }
...
function Account-Discovery
{
    ...
    (
       ...
       Process
        ...
        if($Group) 
            {
            Get-LocalGroup > ##<enter baseline.txt pathway here>
            Write-Host "Groups not identified on baseline: "
            Compare-Object -ReferenceObject (Get-Content -Path <enter baseline.txt pathway here>) -DifferenceObject (Get-Content -Path <enter baseline.txt pathway here>) >> ##<enter Accountability.csv pathway here>
            echo "Date/ Time: $(Get-Date)" >> ##<enter Accountability.csv pathway here>
            echo "Operator initials: $($global:initials)" >> ##<enter Accountability.csv pathway here>
            echo "Command used: " >> ##<enter Accountability.csv pathway here>
            echo "Compare-Object -ReferenceObject (Get-Content -Path C:\Users\Public\LocalGroup_baseline.txt) -DifferenceObject (Get-Content -Path <enter baseline.txt pathway here>) >> <enter Accountability.csv pathway here>)" >> ##<enter Accountability.csv pathway here>
            echo "" >> ##<enter Accountability.csv pathway here>
            }

        if($User)
            {
            Get-LocalUser > ##<enter baseline.txt pathway here>
            Write-Host "Users not identified on baseline: "
            Compare-Object -ReferenceObject (Get-Content -Path <enter baseline.txt pathway here>) -DifferenceObject (Get-Content -Path <enter baseline.txt pathway here>)
            echo "Date/ Time: $(Get-Date)" >> ##<enter Accountability.csv pathway here>
            echo "Operator initials: $($global:initials)" >>##<enter Accountability.csv pathway here>
            echo "Command used: " >> ##<enter Accountability.csv pathway here>
            echo "Compare-Object -ReferenceObject (Get-Content -Path <enter baseline.txt pathway here>) -DifferenceObject (Get-Content -Path <enter baseline.txt pathway here>)" >> ##<enter Accountability.csv pathway here>
            echo "" >> ##<enter Accountability.csv pathway here>
            }
                ...
                echo "Operator initials: $($global:initials)" >> ##<enter Accountability.csv pathway here>
                echo "Command used: " >> ##<enter Accountability.csv pathway here>
                echo "Get-LocalUser | Select Name, LastLogon, PasswordLastSet" >> ##<enter Accountability.csv pathway here>
                echo "" >> ##<enter Accountability.csv pathway here>
                }
         }
}
...
function Network-Process
{
    ...
    echo "Operator initials: $($global:initials)" >> ##<enter Accountability.csv pathway here>
    echo "Command used: " >> ##<enter Accountability.csv pathway here>
    echo "gwmi win32_process | select ProcessID, ParentProcessID, ProcessName, ExecutablePath" >> ##<enter Accountability.csv pathway here>
    echo "" >> ##<enter Accountability.csv pathway here>
}
...
[array]$DropDownArray = "Discover Hosts", "PII Location", "File Discovery", "Account Discovery", "Network Processes"

function Return-DropDown 
{
	$Choice = $DropDown.SelectedItem.ToString()
	$Form.Close()
        if ($choice -eq "Discover Hosts") 
        {
...
$label = New-Object System.Windows.Forms.Label
$label.Location = New-Object System.Drawing.Point(130,60)
$label.Size = New-Object System.Drawing.Size(100,20)
$label.Text = 'Enter initials: '
$form.Controls.Add($label)

$textBox = New-Object System.Windows.Forms.TextBox
$textBox.Location = New-Object System.Drawing.Point(130,80)
...
$Button.Location = new-object System.Drawing.Size(130,130)
$Button.Size = new-object System.Drawing.Size(100,20)
$Button.Backcolor = 'White'
$Button.Text = "OK"
$Button.Add_Click({Return-DropDown;$global:initials=$textBox.Text})
